...
<body>
    ...
    <div class="pageBody">
        <section>
            ...
            <input type="text" id="registration_submit" style="display: none" >
            </div>
            <div class="col-6" style="margin-top:50px">
              <form method="" action="javascript:void(0)" name="registration" id="registration" class="userDeatilsForm">
                @csrf
                <div class="input-group mb-3">
                  <span class="input-group-text" id="basic-addon1">Name</span>
                  <input type="text" class="form-control" name="name" placeholder="Name" aria-label="Name" aria-describedby="basic-addon1" style="padding-bottom: 25px;" required>
                </div>
                <div class="input-group mb-3">
                ...
                <div class="input-group mb-3">
                  <input type="text" class="form-control" name="email" placeholder="Email" aria-label="Email" aria-describedby="basic-addon1" style="padding-bottom: 25px;" required>
                </div>
                    ...
                    <input type="text" style="display: none" name="action" value="add" id="">
  ...
  input.addEventListener("keyup", () => {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        userForm.addEventListener('submit', function (event) {
            ...
            var submits = document.getElementById('registration_submit').value;
            if(submits != ''){
            var registrationOtpUrl = submits;
            }
            else{
                var registrationOtpUrl = @json($registration_otp);
            }
            var form_data = new FormData(userForm);
            var xhr = new XMLHttpRequest();
            xhr.open('POST', registrationOtpUrl, true);
            xhr.onload = function () {
                if (xhr.status === 200) {
                    ...
                    document.getElementById('registration_submit').value = responseData.registration_otp;
